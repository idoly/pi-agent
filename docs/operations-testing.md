...
| Provider terminal invariant | Anthropic SSE and Bedrock Smithy tests append terminal and malformed semantic tail frames in both success/error directions; exactly one terminal event is published while Smithy framing remains validated. |
