...
| Anthropic Messages | `COMPATIBLE` | `AnthropicMessagesModelStream`, `CacheRetention`, durable `addedToolNames` | Deferred references, none/short/long cache placement, stream-event, and terminal-error fixtures |
